...
user4 = User.create(first_name: 'Stephen', last_name: 'Fang', email: 'sf@test.com', password: 'password', password_confirmation: 'password')
...
author4 = Author.create(first_name: 'Patrick', last_name: 'Rothfuss')
...
book9 = Book.create(title: 'The name of the Wind', author: author4, publication: '2009', creator: user4)
...
review6 = Review.create(rating: 5, body: Faker::Hacker.say_something_smart, book: book9, user: user4)
review7 = Review.create(rating: 5, body: Faker::Hacker.say_something_smart, book: book1, user: user4)
